 ...
 * so typedefs and function pointers clash. glibc's <sys/stat.h> reaches
 * asm/types.h via bits/statx.h; with musl, e2fsdroid gets there through
 * libcutils' private/fs_config.h and <linux/capability.h>.
 *
 ...
 *
 * Force-included via -include for the affected Linux targets only. */
