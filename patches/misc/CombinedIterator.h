...
struct CombinedIterator {
   using value_type = detail::Value<It1, It2>;
   using reference = detail::RefPair<It1, It2>;
   using difference_type = std::ptrdiff_t;
   using pointer = detail::RefPairPtr<It1, It2>;
   ...
   difference_type operator-(const CombinedIterator& other) const {
      return it1 - other.it1;
   }
